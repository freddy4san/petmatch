  ...
  return (
    <div className="flex h-full min-h-0 flex-col bg-gray-50">
      <div className="sticky top-0 z-20 flex shrink-0 items-center gap-3 bg-gradient-to-r from-purple-500 to-indigo-600 px-4 pb-4 pt-[max(1rem,env(safe-area-inset-top))] text-white">
        <button onClick={closeChat} className="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center flex-shrink-0 hover:bg-opacity-30" aria-label="Back to messages">
          <ChevronLeft size={20} />
        </button>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-4">
        ...
        {hasOlderMessages && messages.length > 0 ? (
          <div className="mb-4 text-center">
            <button type="button" onClick={loadOlderMessages} disabled={isLoadingOlderMessages} className="rounded-full border border-purple-100 bg-white px-4 py-2 text-sm font-semibold text-purple-600 shadow-sm hover:bg-purple-50 disabled:opacity-60">
